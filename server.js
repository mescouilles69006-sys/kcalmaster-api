...
const GROQ_CHAT_MODEL  = 'llama-3.3-70b-versatile';   // Chat principal — rapide et puissant
const GROQ_VISION_MODEL = 'meta-llama/llama-4-scout-17b-16e-instruct'; // Vision — supporte les images

// Route de santé
app.get('/health', (req, res) => {
  res.json({ status: 'OK', message: 'KcalMaster API with Groq is running', models: { chat: GROQ_CHAT_MODEL, vision: GROQ_VISION_MODEL } });
});
...
app.post('/api/claude', async (req, res) => {
  try {
    ...
    // On ignore le modèle envoyé par le client — on force toujours le bon modèle Groq
...
app.post('/api/vision', async (req, res) => {
  try {
    ...
    console.log('📷 Vision request with model:', GROQ_VISION_MODEL);
